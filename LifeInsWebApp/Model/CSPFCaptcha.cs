...
//            pn[i] = Wave(np2.PathPoints[i], amp, size);
    ...
    public void DrawText(string aText)
    {
        ...
        g.FillRectangle(new System.Drawing.Drawing2D.LinearGradientBrush(rect, Color.WhiteSmoke, Color.WhiteSmoke, 0f), rect);
        //g.DrawString(aText, f, new SolidBrush(Color.Black), x, y);
        g.SmoothingMode = SmoothingMode.AntiAlias;
        g.FillPath(new SolidBrush(Color.DarkOliveGreen), path);
